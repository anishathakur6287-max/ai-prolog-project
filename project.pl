%  COLLEGE RECOMMENDATION SYSTEM — Full Prolog Implementation
...
course_offered(iit_bombay,    mtech, computer_science).
...
placement_stat(iit_bombay,    28, 3000, 95).
placement_stat(iit_delhi,     26, 2800, 95).
...
hostel_ok(_CollegeID, no)  :- !.   %% Student doesn't need hostel → always ok
